...
<div class="auth-page auth-page--wide">
    <div class="card auth-card">
        <div class="card-body">
            <h1 class="auth-title">New thread</h1>
            ...
            <?= form_open_multipart('threads/create') ?>
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <select name="category_id" id="category_id" class="form-select" required>
                    ...
                    <?php foreach ($categories as $c): ?>
                        <option value="<?= (int) $c['id'] ?>" <?= (int) old('category_id') === (int) $c['id'] ? 'selected' : '' ?>><?= esc($c['name']) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <small class="form-text text-muted">Optional. Accepted formats: JPG, PNG, GIF, WebP. Max size: 5MB.</small>
            </div>
            ...
            <button type="submit" class="btn btn-auth-primary mb-2">Create thread</button>
            <a class="btn btn-auth-outline btn-auth-outline--auto" href="<?= base_url('threads') ?>">Cancel</a>
